...
if (scriptTag) {
    require.config({
        ...
        paths: {
            jquery: 'https://cdn.iwshop.org/scripts/jquery-1.7.2.ext.min',
            lobibox: 'https://cdn.iwshop.org/scripts/lobibox.min',
            bootstrap: 'https://cdn.iwshop.org/scripts/bootstrap.min',
            util: 'Wdmin/util',
            Spinner: 'https://cdn.iwshop.org/scripts/spin.min',
            highcharts: 'https://cdn.iwshop.org/scripts/highcharts',
            fancyBox: 'lib/fancyBox/source/jquery.fancybox.pack',
            datatables: 'lib/DataTables/media/js/jquery.dataTables.min',
            jqPaginator: 'https://cdn.iwshop.org/scripts/jqPaginator',
            provinceCity: 'lib/provinceCity',
            jUploader: 'https://cdn.iwshop.org/scripts/jUploader.min',
            ...
            pagination: 'https://cdn.iwshop.org/scripts/jquery.pagination.min',
            datetimepicker: 'https://cdn.iwshop.org/scripts/jquery.datetimepicker.full.min',
            baiduTemplate: 'https://cdn.iwshop.org/scripts/baiduTemplate',
            'jquery-mousewheel': 'https://cdn.iwshop.org/scripts/jquery-mousewheel',
