        ...
        <section class="clearfix">
            {foreach from=$sc.products item=pd name=pds}
                <a href="?/vProduct/view/id={$pd.product_id}" class="hplist">
                    <img src="{$pd.catimg}@1e_1c_0o_0l_300h_300w_90q.src" />
...
<!-- serials -->
<script data-main="{$docroot}static/script/Wshop/shop_index.js" src="http://apps.bdimg.com/libs/require.js/2.1.9/require.min.js"></script>
