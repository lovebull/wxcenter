...
<head>
    ...
    <link href="https://cdn.iwshop.org/scripts/font-awesome.min.css" type="text/css" rel="Stylesheet"/>
    <script type="text/javascript" src="https://cdn.iwshop.org/scripts/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" src="https://cdn.iwshop.org/scripts/bootstrap/3.3.4/bootstrap.min.js"></script>
